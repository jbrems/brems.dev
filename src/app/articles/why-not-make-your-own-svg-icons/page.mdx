...
<SvgRaster columns={10} rows={10} size={30} >
...
Also, the `stroke-linecap` _(the caps or endings of the line)_ are drawn half a unit past the line's endpoints.
...
<SvgRaster columns={10} rows={8} size={30} >
